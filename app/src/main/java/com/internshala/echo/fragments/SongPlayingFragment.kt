...
class SongPlayingFragment : Fragment() {
    ...
    object Statified {
        ...
        var shuffleImageButtom: ImageButton? = null
    ...
    override fun onCreateView(
        ...
        Statified.shuffleImageButtom=view?.findViewById(R.id.shuffleButton)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        var _songTitlle: String?=null
        var _songArtist: String?=null
        var songId: Long = 0
        try {
            path= arguments!!.getString("path")
            _songTitlle= arguments!!.getString("songTitle")
            ...
            Statified.currentSongHelper?.songTitle= _songTitlle
        ...
        if (isShuffleAllowed as Boolean){
            ...
            Statified.currentSongHelper?.isLoop = false
            Statified.shuffleImageButtom?.setBackgroundResource(R.drawable.shuffle_icon)
            Statified.loopImageButton?.setBackgroundResource(R.drawable.loop_white_icon)
        }else{
            Statified.currentSongHelper?.isShuffle=false
            Statified.shuffleImageButtom?.setBackgroundResource(R.drawable.shuffle_white_icon)
        ...
        if (isLoopAllowed as Boolean){
            ...
            Statified.shuffleImageButtom?.setBackgroundResource(R.drawable.loop_white_icon)
            Statified.currentSongHelper?.isLoop=false
    ...
    fun clickHandler(){
        ...
        Statified.shuffleImageButtom?.setOnClickListener{
